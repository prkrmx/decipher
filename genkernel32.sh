...
echo 'kernel void krak(global ulong *buf, ulong slices) {
  ...
  private uint cr1r2, cr1r3, cr2r3, clock1, clock2, clock3, fb1, fb2, fb3;
  private uint iclk1, iclk2, iclk3;
...
echo 'for(i=0; i<32; i++) {             // for each slice
        buf[myptr + i*4] = 0;
